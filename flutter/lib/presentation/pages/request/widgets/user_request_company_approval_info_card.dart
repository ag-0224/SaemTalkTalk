...
class _UserRequestCompanyApprovalInfoCard extends ConsumerWidget {
  const _UserRequestCompanyApprovalInfoCard({required this.title, required this.content, super.key});
